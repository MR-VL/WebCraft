...
export const defs = (() =>{
    ...
    return{
        ...
        MoonColor: new THREE.Color(0xf4ffbe).convertSRGBToLinear(),
        UnderWaterColor: new THREE.Color(0x345aa2).convertSRGBToLinear(),
        SkyColor: new THREE.Color(0x93bfdd).convertSRGBToLinear(),
